...
static const auto DistributedC10dFrontendTorchBind =
    torch::class_<::c10d::DistributedC10d>("dist_c10d", "frontend")
        ...
        .def("set_test_value", &::c10d::DistributedC10d::setTestValue)
        .def("get_test_value", &::c10d::DistributedC10d::getTestValue)
        .def("register_process_group_name", &::c10d::DistributedC10d::registerProcessGroupName);
